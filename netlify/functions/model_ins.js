...
const { Employee } = require('../../backend/Schemas/model_ins_schema.js');
...
console.log("+++++++",event.body.email)
        let jsonObj ={score:JSON.parse(event.body).score,user_id:JSON.parse(event.body).id,date:JSON.parse(event.body).date}
